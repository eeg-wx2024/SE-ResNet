...
class classifier_MLP(nn.Module):
    def __init__(self, in_channel=256, num_points=256, num_classes=40):
        super(classifier_MLP, self).__init__()

        # Define the layers for the MLP model
        self.fc1 = nn.Linear(in_channel * num_points, 512)  # Flatten the input to (96*512)
        self.fc4 = nn.Linear(512, num_classes)              # Output layer for classification
...
class classifier_EEGChannelNet(nn.Module):
    ...
    def __init__(self, spatial=256, temporal=256):
...
class no_classifier_EEGChannelNet(nn.Module):
    def __init__(self, spatial=127, temporal=500, n_classes=50):
        super(classifier_EEGChannelNet, self).__init__()
...
if __name__ == "__main__":
    device = "cuda:0"
    net = classifier_EEGChannelNet().to(device)
