...
def main():
    ...
    parser.add_argument('--model', type=str, required=True, help='Model to use: EEGNet, classifier_EEGNet, classifier_SyncNet, classifier_CNN, classifier_EEGChannelNet')
